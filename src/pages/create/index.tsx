...
export default function Create() {
  ...
  async function handleCreateSubmission(data: ICreate){
    JSON.stringify(data)
    try {
  ...
  const  handleCreate: SubmitHandler<ICreate> = async (values) => {
  ...
  return (
    ...
    <Flex w="100%" my="6" maxWidth={1480} mx="auto" px="6">
      ...
      <Flex mb="8" justify="space-between" align="center" direction="column">
        ...
        <FormControl as="form" onSubmit={handleSubmit(handleCreate as  SubmitHandler<FieldValues>)}>
